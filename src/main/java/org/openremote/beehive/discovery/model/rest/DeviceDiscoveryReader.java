...
public class DeviceDiscoveryReader implements MessageBodyReader<DeviceDiscovery> {
    ...
    public static final String JSON_HTTP_CONTENT_TYPE = "application/vnd.openremote.device-discovery+json";
    ...
    @Override
    public DeviceDiscovery readFrom(Class<DeviceDiscovery> type, Type genericType,
                                    Annotation[] annotations, MediaType mediaType,
